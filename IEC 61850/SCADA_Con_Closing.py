...
def check_if_conf_changed(con, nr):
    ...
    if nr in gvar.configRev.keys():
        ...
        gvar.configRev[nr] = lln0_namplt_config_rev
...
def test_client(ip, nr):
    ...
    while True:
        ...
        # let connection open
        #time.sleep(60) # 900s for every 15 min
        time.sleep(900) # 900s for every 15 min
